...
>
  ...
  >
    <li class="flex text-sm leading-none text-gray-900">
      ...
      <a
        class="flex items-center -ml-px px-3 py-2 font-semibold border border-gray-400 rounded-r-md"
        href="#_">124</a
      >
    </li>
    <li class="flex items-stretch justify-center text-gray-900">
      ...
      <a
        class="flex items-center -ml-px px-3 py-2 text-sm font-semibold leading-none border border-gray-400 rounded-r-md"
        href="#_">4</a
      >
    </li>
